pipeline {
    ...
    environment {
        // Your actual AWS region
        AWS_REGION = 'us-east-1'

        // Your actual ECR repository URIs, from the terraform outputs
        FRONTEND_REPO = '940213460431.dkr.ecr.us-east-1.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '940213460431.dkr.ecr.us-east-1.amazonaws.com/devops-challenge-backend'
    }
