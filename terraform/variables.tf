# Every "variable" block below defines one reusable input.
# Anywhere else in this project you'll see var.<name> — that pulls the
# value from here. The "default" is what gets used if you don't override it.
